      ...
      <section className="site-section">
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay={300}>
              <div className="owl-carousel slide-one-item-alt-text">
                ...
                <div>
                  ...
                  <p className="lead">Participating grocers, restaurateurs, and food delivery services expand their customer base while receiving a subsidy for discounting healthy options.</p>
